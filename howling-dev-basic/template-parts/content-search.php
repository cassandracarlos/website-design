	    ...
	    <div class="hd-blog-card">
    	    <div class="hd-blog-card-left">
	            <h3 class="hd-blog-card-category">
             	...
             	<p class="hd-blog-card-meta"><?php _e( 'By ', 'howling-dev-basic') ?><a href="<?php echo get_author_posts_url( get_the_author_meta('ID')) ?>"><?php the_author(); ?></a>&nbsp<?php the_date(); ?></p>
          	</div><!-- End .hd-blog-card-left -->
