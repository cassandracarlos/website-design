...
<article id="post-<?php the_ID(); ?>" class="<?php echo esc_attr( implode( ' ', get_post_class() ) ) ?>">
   ...
   <div class="hd-blog-card">
      <div class="hd-blog-card-left">
         ...
         <p class="hd-blog-card-meta"><?php _e( 'By ', 'howling-dev-basic' ); ?><a href="<?php echo get_author_posts_url( get_the_author_meta('ID')) ?>"><?php the_author(); ?></a><?php _e( ' | ', 'howling-dev-basic' ); the_date(); ?></p>
      </div>
