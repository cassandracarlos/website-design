...
<?php get_header(); ?>
<style>
	/* howling-dev-basic-attachment.css */
	.howling-dev-basic-attachment img {
		margin: 1em auto;
	}

	.howling-dev-basic-attachment-caption {
	    font-size: .75em;
	    text-align: center;
	    margin-top: 3em;
	}

	/* This breaks up long strings of text like urls in attachment page */
