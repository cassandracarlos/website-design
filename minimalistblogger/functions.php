...
function minimalistblogger_spbThemesNotification()
{
    ...
    $options_notification_start_promotion = array("delay" => "1 hour", "wpautop" => false);
    $notifications->Add('minimalistblogger_notification_start_promotion', "The 2023 Remake of Minimalist Blogger Is Live: Download It for Free", '
              <span class="freeupgrade-wrapper">
        <span class="freeupgrade-wrapper-image">
          <img src="' . esc_url(get_template_directory_uri() . '/inc/admin_notification/src/remake.png') . '" width="170" height="127" />
        </span>
        <span class="freeupgrade-wrapper-content">
          <p>Experience the 2023 remake of MinimalistBlogger with Minimalist Blogger X! Unlock full eCommerce integration, 200+ new features and much more. Click the button below to read more or download it for free!</p>
          <ul class="freeupgrade-wrapper-content-buttons">
             <li><a href="https://superbthemes.com/minimalist-blogger-x/" target="_blank" class="button button-secondary">Read more</a> </li>
             <li><a href="' . esc_url(admin_url('theme-install.php?search=meet%20minimalist%20blogger%20x')) . '" class="button button-primary">Install Minimalist Blogger X Free </a></li>
             </ul>
        </span>
      </span>

      <style>
span.freeupgrade-wrapper { display: -webkit-box; display: -ms-flexbox; display: flex; -webkit-box-align: center; -ms-flex-align: center; align-items: center; border-top: 1px solid #eee; padding: 10px 0; } span.freeupgrade-wrapper-image { margin-right: 14px; } span.freeupgrade-wrapper-content p { max-width: 600px; font-size: 15px; } ul.freeupgrade-wrapper-content-buttons { display: -webkit-box; display: -ms-flexbox; display: flex; } ul.freeupgrade-wrapper-content-buttons li { margin: 10px 10px 0 0px; } @media screen and (max-width: 600px) { span.freeupgrade-wrapper-image { display:none; } }
      </style>
        ', "info", $options_notification_start_promotion);
    $notifications->Boot();
}
