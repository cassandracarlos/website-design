...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--50)"><!-- wp:heading {"textAlign":"center","level":1,"textColor":"heading-color"} -->
    <h1 class="wp-block-heading has-text-align-center has-heading-color-color has-text-color"><?php echo esc_html('Testimonials', 'fotawp') ?></h1>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"align":"center","textColor":"sub-heading-color"} -->
    <p class="has-text-align-center has-sub-heading-color-color has-text-color"><?php echo esc_html('Lorem ipsum, or&nbsp;lipsum&nbsp;as it is sometimes known, is dummy text used in laying out print, graphic or web designs.', 'fotawp') ?></p>
    <!-- /wp:paragraph -->
